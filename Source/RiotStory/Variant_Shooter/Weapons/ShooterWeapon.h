 ...
 */
UCLASS(abstract)
class RIOTSTORY_API AShooterWeapon : public AActor, public IAimIndicatorPathProvider
{
	GENERATED_BODY()
	...
	/** The Aim prediction indicator */
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category="Components", meta = (AllowPrivateAccess = "true"))
	UAimIndicatorComponent* AimIndicatorComponent;
...
public:
	...
	/** Start zooming with this weapon */
	void StartZoom();

	/** Stop zooming with this weapon */
	void StopZoom();
